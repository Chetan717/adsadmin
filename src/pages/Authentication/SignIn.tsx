...
import LogoDark from '../../images/app.png';
...
const SignIn = () => {
  const { apiId, API_KEY, GetAdmin } = DataSupplier();
  ...
  const HandleChange = (e: any) => {
    ...
    // Validate and update the errors state
    setErrors((prev) => {
      return { ...prev, [name]: '' };
    });
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-20">Ads Maker 365 </p>
